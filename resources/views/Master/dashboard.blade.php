    ...
    <div class="page-wrapper">
        <div class="page-content">
          ...
          ?>
            ...
            <table style="width:115%; margin-left:-14%;">
                <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('demand_notice') }}">
                                        <div>
                                            ...
                                            if (is_array(Auth::guard('operator')->user()->zone_id) && in_array('All', Auth::guard('operator')->user()->zone_id)) {
                                                $count1 = DB::table('existing_serves')->where('generate_notice', '1')->count();
                                            
                                                $count = DB::table('serves')->where('generate_notice', '1')->count();
                                            } else {
                                                $count1 = DB::table('existing_serves')
                                                    ->whereIn('zone_no', Auth::guard('operator')->user()->zone_id)
                                                    ->where('generate_notice', '1')
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('generate_certificate') }}">
                                        <div>
                                            ...
                                            if (is_array(Auth::guard('operator')->user()->zone_id) && in_array('All', Auth::guard('operator')->user()->zone_id)) {
                                                $count1 = DB::table('existing_serves')->where('status', '1')->count();
                                            
                                                $count = DB::table('serves')->where('status', '1')->count();
                                            } else {
                                                $count1 = DB::table('existing_serves')
                                                    ->whereIn('zone_no', Auth::guard('operator')->user()->zone_id)
                                                    ->where('status', '1')
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="#">
                                        <div>
                                            ...
                                            if (is_array(Auth::guard('operator')->user()->zone_id) && in_array('All', Auth::guard('operator')->user()->zone_id)) {
                                                $count1 = DB::table('existing_serves')->select(DB::raw('*'))->whereRaw('Date(created_at) = CURDATE()')->count();
