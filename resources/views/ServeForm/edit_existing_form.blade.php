                ...
                <div class="col-md-12" style="margin-left: -8%;">
                    ...
                    <div class="card" style="margin-top:-4%;">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2" method="post" action="{{ route('update_existing') }}" id="form_id">
                                @csrf
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control   to-text " type="text" placeholder="व्यवसाय मालकाचे नाव"
                                        aria-label="default input example" style="margin-top:8px;" name="bussiness_owner1" value="{{ $edit_data->bussiness_owner1 }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control from-text " type="text" placeholder="Name of Corporation"
                                        aria-label="default input example" name="contact_person" value="{{ $edit_data->contact_person }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control   to-text " type="text" placeholder="संपर्क व्यक्तीचे नाव"
                                        aria-label="default input example" style="margin-top:8px;" name="contact_person1" value="{{ $edit_data->contact_person1 }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 from-text" type="text" placeholder="Shop/House No"
                                        aria-label="default input example" name="shop_house_no" value="{{ $edit_data->shop_house_no }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3  to-text " type="text" placeholder="दुकान घर क्र."
                                        aria-label="default input example" style="margin-top:8px;" name="shop_house_no1" value="{{ $edit_data->shop_house_no1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Name of Building</label>
                                    <input class="form-control mb-3  from-text" type="text"
                                        placeholder="Building Name" aria-label="default input example" name="bulding" value="{{ $edit_data->bulding }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3  to-text " type="text" placeholder="इमारतीचे नाव"
                                        aria-label="default input example" style="margin-top:8px;" name="bulding1" value="{{ $edit_data->bulding1 }}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3  to-text" type="text"
                                        ...
                                        style="margin-top:8px;" name="street_name1" value="{{ $edit_data->street_name1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Locality</label>
                                    <input class="form-control mb-3 from-text " type="text" placeholder="Locality"
                                        aria-label="default input example" name="locality" value="{{ $edit_data->locality }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3 to-text" type="text" placeholder="परिसर"
                                        aria-label="default input example" style="margin-top:8px;" name="locality1" value="{{ $edit_data->locality1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Prabhag Name</label>
                                    <input class="form-control mb-3 from-text" type="text" placeholder="Prabhag Name"
                                        aria-label="default input example" name="prabhag_name" value="{{ $edit_data->prabhag_name1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 to-text " type="text" placeholder="झोन क्र."
                                        ...
                                        id="zones_id" readonly value="{{ $edit_data->pincode }}">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Pin Code</label>
                                    <input class="form-control mb-3 from-text " type="text" placeholder="Pin Code"
                                        aria-label="default input example" name="pincode" value="{{ $edit_data->pincode1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3 to-text " type="text" placeholder="पिन कोड"
                                        aria-label="default input example" style="margin-top:8px;" name="pincode1" value="{{ $edit_data->email }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 from-text " type="text" placeholder="Email ID"
                                        aria-label="default input example" name="email" value="{{ $edit_data->email1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3 to-text " type="text" placeholder="ईमेल आयडी"
                                        aria-label="default input example" style="margin-top:8px;" name="email1" value="{{ $edit_data->wht_app_no }}">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Whatsapp No</label>
                                    <input class="form-control mb-3 from-text " type="text" placeholder="Whatsapp No."
                                        aria-label="default input example" name="wht_app_no" value="{{ $edit_data->wht_app_no1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3 to-text " type="text"
                                        placeholder="व्हॉट्सअॅप नंबर" aria-label="default input example"
                                        style="margin-top:8px;" name="wht_app_no1" value="{{ $edit_data->gst_no }}">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">GST No</label>
                                    <input class="form-control mb-3 from-text " type="text" placeholder="GST"
                                        aria-label="default input example" name="gst_no" value="{{ $edit_data->gst_no1 }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select from-text mb-3" aria-label="Default select example"
                                        ...
                                        <option value="{{ $business_type->id }}" @if ($edit_data->bussiness_type_id == $business_type->id) selected @endif>{{ $business_type->business_type }}
                                        </option>
                                    @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3" style="margin-top: 4.2vh">
                                    ...
                                    <input class="form-control to-text mb-3" type="text"
                                        ...
                                        style="margin-top:8px;" name="bussiness_type1" id="bussiness_type1" value="{{ $edit_data->business_type1 }}">
                                ...
                                <div class="col-md-3" style="margin-top: 4.2vh">
                                    ...
                                    <input class="form-control to-text mb-3" type="text"
                                        placeholder="व्यवसायाचे प्रकार " aria-label="default input example"
                                        style="margin-top:8px;" name="type_of_bussiness_id1" id="bussinesss" value="{{ $edit_data->type_of_bussiness_id1 }}">
                                ...
                                <div class="row" id="other_hotel">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control from-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="non_ac_room" id="other36" value="{{ $edit_data->non_ac_room }}">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control to-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="ac_room1" id="other16" value="{{ $edit_data->non_ac_room1 }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control from-text  mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="ac_room" id="other6" value="{{ $edit_data->ac_room }}">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control to-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="non_ac_room1" id="other366" value="{{ $edit_data->ac_room1 }}">
                                    </div>
                                    {{-- <div class="col-md-3">
									<label class="form-label">No Of Non Ac Room</label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control  to-text mb-3" type="text" placeholder="व्यवसायाचे नाव"
                                        ...
                                        name="bussiness_name1" value="{{ $edit_data->bussiness_name1 }}">
                                </div>
                                ...
                                <div class="col-md-3" style="margin-top: 4.2vh">
                                    ...
                                    <input class="form-control to-text mb-3 " type="text"
                                        ...
                                        style="margin-top:8px;" name="type_of_licence_id1" id="licencess_id" value="{{ $edit_data->type_of_licence_id1 }}">
                                ...
                                <div class="row" id="other_div">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control from-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="licence_name" id="other" value="{{ $edit_data->licence_name }}">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control to-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="licence_name1" id="other1" value="{{ $edit_data->licence_name1 }}">
                                ...
                                <div class="row" id="not_avail_div">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control from-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="licence_no" id="other3" value="{{ $edit_data->licence_no }}">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control to-text mb-3" type="text"
                                            ...
                                            style="margin-top:8px;" name="licence_no1" id="other4" value="{{ $edit_data->licence_no1 }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 from-text " type="text"
                                        ...
                                        aria-label="default input example" name="no_of_employee_working" value="{{ $edit_data->no_of_employee_working }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"></label>
                                    <input class="form-control mb-3 to-text " type="text"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 to-text" type="text"
                                        ...
                                        style="margin-top:8px;" name="area_of_bussiness1" value="{{ $edit_data->area_of_bussiness1 }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-primary px-5 add-row" style="margin-top: 3.8vh;"><i
