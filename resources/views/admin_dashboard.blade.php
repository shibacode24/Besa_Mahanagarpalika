                ...
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#primaryhome" role="tab"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="tab-title">License Approval</div>
                                        </div>
                                    </a>
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                                                                ...
                                                                <td style="background-color: #fff">
                                                                    ...
                                                                    <a href="{{ route('print-serve', $serve_all->id) }}"
                                                                        target="_blank"><button type="button"
                                                                            class="btn1 btn-outline-secondary" data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" title="Receipt Print"><i
                                                                                class='bx bx-receipt me-0'></i></button>
                                                                    </a>


                                                                    @if ($serve_all->status == 0)
                                                                        <a href="{{ route('update_status', $serve_all->id) }}"
                                                                            onclick="return confirm('Do You Want To Approve This?')"><button
                                                                                type="button"
                                                                                class="btn1 btn-outline-success label_change1"><i
                                                                                    class="lnilni-success">Approve</i></button></a>
                                                                    @endif
                                                        ...
                                                        @foreach ($data as $data1)
                                                            <tr>
                                                                ...
                                                                <td style="background-color: #fff">
                                                                    ...
                                                                    @if ($data1->status == 0)
                                                                        <a href="{{ route('update_status_existing', $data1->id) }}"
                                                                            onclick="return confirm('Do You Want To Approve This?')"><button
                                                                                type="button"
                                                                                class="btn1 btn-outline-success label_change1"><i
                                                                                    class="lnilni-success">Approve</i></button></a>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show " id="primaryprofile" role="tabpanel">
                                    {{-- <div class="col-md-12 mx-auto"> --}}
                                    <div class="card" >
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="example1" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($new_notice2 as $serve_all)
                                                            <tr>
                                                                {{-- <td>{{ $loop->index + 1 }}</td> --}}
                                                                {{-- <td>{{ $serve_all->survey_app_no }}</td> --}}
                                                                <td data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="example3" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($new_notice3 as $serve_all)
                                                            <tr>
                                                                {{-- <td>{{ $loop->index + 1 }}</td> --}}
                                                                {{-- <td>{{ $serve_all->survey_app_no }}</td> --}}
                                                                <td data-bs-toggle="tooltip" data-bs-placement="top"
																...
																<tr>
																 ...
																 <td>{{ $data1->receipt_no }}</td>
																	<td style="background-color: #fff">
																		...
																		<a href="{{ route('print-serve1', $data1->id) }}" target="_blank"><button
																			type="button"
																	...
																	<a href="{{ route('update_status_existing', $data1->id) }}"  onclick="return confirm('Do You Want To Approve This?')"><button
																		type="button" 
																		class="btn1 btn-outline-success label_change1"><i
																			class="lnilni-success" >Approve</i></button></a>
