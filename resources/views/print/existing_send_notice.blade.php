...
<body style="font-family:Arial;font-size:11px">
  <div style="width:100%;font-size:15px;">
    ...
    <p style="margin-rigth: 85%;">जावक क्र.:Outward/BESA{{$data->survey_app_no}}01</p>
    <h1 align="center">नोटीस-01</h1>
    <p>प्रती</p>
    ...
    <p>विषय: महाराष्ट्र महानगर-  अधिनियमाचे अन्वये महानगर- बाजार व परवाना विभागाचा परवाना (Trade License) काढण्याबाबत.</p>
    <p>आपणास या दवारे सूचित करन्यात येते कि,  पिंपळा महानगर- क्षेत्रात आपण <b>{{$data->establishment1}}</b> या नावाने व्यवसाय करीत आहात. महाराष्ट्र महानगर- अधिनियमातील अंतर्गत आपले व्यवसायचा परवाना (Trade License) काढून घेणे अनिवार्य आहे.आपण अधाप परवाना  काढलेला नाही. या मध्ये आपण नियमाचे उलंघन केले असल्याचे सकृतदर्शनी दिसून येते.</p>
  ...
  @json($data->certificate_year) --}}
    ...
    <td style="  border: 1px solid black;text-align: center;">
       ...
       {{ ($non_ac + $ac) * ($data->past_year + $data->certificate_year) }}
      @else
      
      {{ ($data->reg_fee + $data->charges * ($data->past_year + $data->certificate_year))  }}
      @endif
...
<table>
  ...
  <td>
    <img src="{{ asset('images/seal_NMC.png')}}" style="z-index:99999; width:120px;"  /> 
  </td>
  <td>
...
<img src="{{ asset('images/seal_NMC.png')}}" style="z-index:99999;"  /> --}}
